          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("You have booked:",style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.w700
                      ),),
                      SizedBox(height: 5,),
                      Text("8:00 adviced by Tom", style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w400
                      ),),
                      
                      Text("13:00 adviced by Emily", style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w400
                      ),)
                    ],
            ...
            Expanded(
              child:GridView.count(crossAxisCount: 2,
                ...
                children: [
                  serviceWidget("sendMoney", "Lawyer Consultation"),
                  serviceWidget("receiveMoney", "List all lawyers"),
                  serviceWidget("phone", "Field Of Law"),
                  serviceWidget("electricity", "Legal Documents"),
                ],
              ),
            )
